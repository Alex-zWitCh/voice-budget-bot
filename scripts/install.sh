...
write_env() {
  ...
  prompt WELCOME_INTRO "Текст приветствия" "Отправьте короткое голосовое или текстовое сообщение, чтобы записать доход, расход, напоминание или отложенное списание." 0
